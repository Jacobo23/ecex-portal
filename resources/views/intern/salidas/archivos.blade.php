...
<div class="p-6 bg-white border-b border-gray-200">
        ...
        <div class='img_card col-lg-3' style='padding:10px'>
            ...
            <h6><a href='/int/salidas/{{ $outcome->id }}/download_pdf'><i class="fa-solid fa-file-pdf"></i></a>  <b>PDF</b> </h6>
            </div>
        ...
        <div class='img_card col-lg-3' style='padding:10px'>
            <div class='img_card_top'>
            <h6><a href='/int/entradas/{{ $entrada->id }}/download_pdf'><i class="fa-solid fa-file-pdf"></i></a> <b>PDF - {{ $entrada->getIncomeNumber()}}</b></h6>
            </div>
        </div>
        @endforeach
